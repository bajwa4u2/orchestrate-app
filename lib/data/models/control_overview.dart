class ControlOverview {
  ...
  factory ControlOverview.fromJson(Map<String, dynamic> json) {
    return ControlOverview(
      ...
      today: OverviewToday.fromJson(
          (json['today'] as Map?)?.cast<String, dynamic>() ?? {}),
      execution: OverviewExecution.fromJson(
          (json['execution'] as Map?)?.cast<String, dynamic>() ?? {}),
      deliverability: OverviewDeliverability.fromJson(
          (json['deliverability'] as Map?)?.cast<String, dynamic>() ?? {}),
      alerts: OverviewAlerts.fromJson(
...
class OverviewToday {
  OverviewToday(
      {required this.sent, required this.replies, required this.booked});
  final int sent;
  final int replies;
  final int booked;
...
class OverviewExecution {
  ...
  factory OverviewExecution.fromJson(Map<String, dynamic> json) =>
      OverviewExecution(
...
class OverviewDeliverability {
  ...
  factory OverviewDeliverability.fromJson(Map<String, dynamic> json) =>
      OverviewDeliverability(
...
class OverviewAlerts {
  ...
  final int open;
  factory OverviewAlerts.fromJson(Map<String, dynamic> json) =>
      OverviewAlerts(open: (json['open'] ?? 0) as int);
}
